...
kubectl get nodes --namespace kubespace -o wide
...
kubectl get pods --namespace kubespace -o wide
...
kubectl get deployments --namespace kubespace -o wide
...
kubectl get services --namespace kubespace -o wide